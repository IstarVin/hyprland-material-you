      ...
      Widget.Box({
        ...
        children: [
          Widget.Button({
            ...
            class_name: "management_button",
            on_clicked: () => {
              Utils.execAsync(`${App.configDir}/scripts/dark-theme.sh --toggle`)
                .catch(print);
        ...
        children: [
          Widget.Button({
            ...
            on_clicked: () => {
              ...
              } else {Utils.execAsync("pkill -f wayland-idle-inhibitor.py")
                  .catch(print);}
            },
            setup: (self) => {
...
export function Management() {
  ...
  return Widget.EventBox({
    ...
    on_scroll_up: () =>
      current_page.setValue(Math.max(current_page.value - 1, 0)),
    child: Widget.Box({
      orientation: Gtk.Orientation.VERTICAL,
      children: [
        stack,
