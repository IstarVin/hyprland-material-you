...
import { Notification, NotificationPopups } from "modules/notificationPopups";
...
export function NotificationsBox(
  { exclude = [], include = [] }: NotificationsBoxType,
) {
      ...
      child: Widget.Box({
        ...
        setup: (self) => {
          popups.connect("notify::children", () => {
            ...
            (self.children[1] as RevealerType).reveal_child =
              popups.children.length == 0;
          });
        },
      }),
      hexpand: true,
