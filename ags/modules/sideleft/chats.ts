    ...
    const thisMessage = Widget.Box({
        ...
        children: [
            ...
            Widget.Box({
                ...
                children: [
                    message.type == 3 ||
                        (message.type == 4 && message.nickname == "system")
                        ? undefined
                        : Widget.Label({
                            hpack: "start",
                            xalign: 0,
        ...
        Widget.Scrollable({
            ...
            setup: (scrolledWindow) => {
                ...
                Utils.timeout(1, () => {
                    ...
                    viewport.set_focus_vadjustment(
                        new Gtk.Adjustment(undefined),
                    );
                });
                ...
                Widget.Box({
                    ...
                    children: [
                        Widget.Button({
                            ...
                            class_name: "filled_tonal_button",
                            on_clicked: (self) => {
                                chatrooms.create_user(username, password).then(
                                    (r) => {
                                        if (
                                            r.data.success &&
                                            !r.data.wait_for_accept
                                        ) {
                                            current.setValue("chat");
                                        }
                                    },
                                );
                            },
                        ...
                        Widget.Button({
                            ...
                            class_name: "filled_button",
                            on_clicked: (self) => {
                                chatrooms.login(username, password).then(
                                    (r) => {
                                        if (r.data.success) {
                                            current.setValue("chat");
                                        }
