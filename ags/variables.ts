...
export const current_wallpaper = Variable(
  `${GLib.get_home_dir()}/dotfiles/wallpapers/default.png`,
);
...
const system_info = JSON.parse(
  await Utils.execAsync(`${App.configDir}/scripts/system.sh --json`),
);
...
export const settings_file =
  `${GLib.get_home_dir()}/dotfiles/.settings/settings.json`;
export const wallpaper_cache_file =
  `${GLib.get_home_dir()}/.cache/current_wallpaper`;
